# Computational Capabilities of Cortical Organoids Compared to Human Cortical Tissue: A Systematic Review

**Word Target per Section: ~2500 words each (Steps 1-8)**
...
□ At least 2 independent experimental approaches
□ Replication across laboratories
□ Clear methodology for calculating information metrics
...
□ Resolution of connectivity measurements
□ Validation of connectivity inference methods
□ Comparison to null models/random networks
...
□ Direct experimental measurements (not just simulations)
□ In vivo validation (not just slice preparations)
□ Multiple cell types characterized
...
- Theoretical calculations of memory capacity
...
- Interaction between multiple plasticity mechanisms

**Evidence quality:**
□ Replication of plasticity rules across labs
□ In vivo confirmation of in vitro findings
□ Functional consequences demonstrated
□ Time constants and magnitudes quantified
...
- Memory traces across timescales
...
**Evidence checklist:**
□ Multiple recording modalities converge
□ Functional role of temporal dynamics established
□ Species comparisons available
□ Quantitative models of temporal processing
...
- Sparse coding and energy optimization
...
**Critical evaluation:**
□ Direct measurements vs theoretical estimates
□ Cell-type-specific measurements
□ Activity-dependent vs baseline metabolism
□ Whole-system vs component-level analyses
...
- Proposed composite metrics for comparison
...
□ Can we reduce to single metric or need multidimensional assessment?
□ Which metrics are most relevant for organoid comparison?
□ What are measurement limitations for each approach?
□ Where does evidence quality not support strong claims?

---

## SECTION 2: Structural Differences Between Organoids and Native Cortex (~2500 words)
...
- Glia/neuron ratios
- Cell type diversity (excitatory vs inhibitory, subtypes)
...
□ Quantitative cell counts with statistics
□ Multiple independent protocols/labs
□ Single-cell resolution data
□ Longitudinal time-series data
□ Comparison to appropriate developmental stages

**Expected evidence gaps:**
[Note: Limited data from adult human cortex for direct comparison]
[Note: High variability between organoid protocols]
...
- Degree of lamination achieved in organoids
...
□ Time-course studies showing layer emergence
□ Multiple independent markers per layer
□ Functional validation (not just marker expression)
...
- Array tomography or expansion microscopy studies
...
- Rabies tracing (in vivo)

**Critical points:**
□ Connectivity measurements at synapse resolution
□ Functional connectivity validation
□ Cell-type-specific connection rules
□ Developmental trajectory of connectivity

**Known limitations:**
[Note: Long-range connections impossible in isolated organoids]
[Note: Limited EM data from human tissue]
...
- Necrotic cores and size limitations
- Hypoxia effects on development
...
- Size limitations before necrosis

**Evidence requirements:**
□ Direct measurements of oxygen/nutrients
□ Correlation with cell death
□ Time-course data
□ Comparison of vascularized vs non-vascularized models
...
- Scaling laws from animal studies
...
- Network size implications

**Critical analysis:**
□ Multiple protocols/labs reporting sizes
□ Statistical distributions of sizes
□ Factors limiting size identified
...
## SECTION 3: Functional Properties Comparison (~2500 words)
...
- Population synchrony and coordination
...
□ Multiple ages/developmental stages
□ Statistical characterization of activity patterns
...
- Short-term plasticity (PPR, depression/facilitation)
...
**Comparison criteria:**
□ Similar recording conditions (temperature, solutions)
□ Cell-type-specific measurements
□ Developmental time-matching
□ Multiple synaptic parameters measured
...
**Evidence standards:**
□ Sufficient recording density for network analysis
□ Appropriate statistical methods
□ Controls for recording artifacts
□ Replication across multiple organoids
...
- Population coding of stimuli

**Evaluation criteria:**
□ Systematic variation of stimulus parameters
□ Quantitative response metrics
□ Multiple neurons/sites recorded
□ Controls for direct vs network-mediated responses
...
## SECTION 4: Developmental Factors (~2500 words)
...
- Stage-matching between organoids and human development
...
- Organoid time-course studies

**Critical comparisons:**
□ Transcriptomic age prediction algorithms
□ Multiple independent markers of maturity
□ Functional milestones aligned to stages
□ Epigenetic/chromatin state comparisons

**Evidence gaps to note:**
[Limited data from human fetal tissue]
[Uncertainty in rate of organoid "aging"]
...
- Effects of sensory deprivation on cortical development
...
- Structural plasticity windows

**Evidence requirements:**
□ Experimental manipulation of activity
□ Long-term developmental consequences measured
...
□ Appropriate biological replicates
□ Comparison to relevant reference tissue
...
- Stress markers (apoptosis, DNA damage)

**Evidence checklist:**
□ Multiple time points characterized
□ Viability quantified
□ Comparison of culture methods
□ Functional assessments at late stages
...
## SECTION 5: Quantitative Comparisons (~2500 words)
...
- Comparison to similar metrics from cortex
...
□ Sufficient data for reliable estimation
□ Bias correction methods used
□ Bootstrap or other validation
□ Comparison to null models

**Expected evidence status:**
[Limited studies applying information theory to organoids]
...
□ Multiple observables reproduced
...
- Signal prediction
- Simple game playing (e.g., Pong with neurons)

**Evidence quality:**
□ Controls for non-specific effects
□ Learning curves demonstrated
□ Generalization to new stimuli
□ Comparison to baseline/control systems

**Expected status:**
[Very limited evidence for task-based learning]
[Emerging field with few publications]
...
- Recommendations for standardized metrics
...
## SECTION 6: Technical and Methodological Limitations (~2500 words)
...
- Voltage imaging (fast but technically challenging)

**Critical assessment:**
□ What fraction of network is sampled?
□ How does sampling affect conclusions?
□ Are artifacts properly controlled?
□ Comparison across techniques for validation
...
- Reproducibility crisis considerations
...
- Handling and passage protocols

**Evidence requirements:**
□ Quantitative metrics of variability
□ Multiple labs/protocols compared
...
- Implications for computational capability assessments
...
□ Comparison to human development timelines
□ Identification of maturation barriers
...
- Sensory deprivation studies as analogies
...
**Evidence to assess:**
□ Studies showing importance of each input type
□ Assembloid rescue experiments
□ Receptor expression in absence of inputs
□ Functional consequences of missing inputs
...
## SECTION 7: Synthesis of Constraints (~2500 words)
...
- Vascularization → viability → functional limits
...
- If 10-100x fewer cells, how does this affect...
  ...
  - Memory capacity?
- If local connectivity only, what computations are lost?
...
- Narrative synthesis
- Clear statement of evidence quality

---

## SECTION 8: Future Directions (~2500 words)
...
- Health/viability improvements

**Evidence assessment:**
□ Functional vasculature demonstrated
...
- Long-range connectivity generation
...
- "fused organoid"
- "cortical subcortical assembloid"

**Key questions:**
□ Do neurons extend axons between regions?
□ Are connections functional and specific?
□ Does this improve computational capability?
...
- Evidence for training/learning
...
**Evidence quality:**
□ Proper controls (open-loop, random feedback)
□ Statistical learning demonstrated
□ Reproducibility
...
**Assessment criteria:**
□ Demonstrated in organoids
□ Scalability
□ Information gain vs existing methods
□ Accessibility to field
...
- Organoids designed for specific computations
...
- Ethical frameworks
- Comparison to alternative approaches (neuromorphic chips)
...
## OVERALL ARTICLE STRUCTURE NOTES
...
- Qualitative only
- Missing controls
- Theoretical only without validation

### Cross-Cutting Themes to Weave Throughout

1. **Developmental stage confound** - organoids ≠ adult tissue
2. **Measurement limitations** - can't see everything
3. **Variability** - high heterogeneity
4. **Missing context** - isolated system
5. **Lack of standardization** - hard to compare studies
6. **Evidence gaps** - many unknowns remain
...
- Where measurement is technically impossible currently
...
- Check for publication bias (funnel plots)
...
4. **Statistics** - correct analysis?
5. **Replication** - reproduced by others?
6. **Generalizability** - applies broadly?
...
- Note when extrapolating beyond data
- Be explicit about assumptions
- Use conditional language for weak evidence
- Cite specific figures/tables when possible

### Reference Management

- Aim for ~150-300 references total (spread across sections)
- Prioritize primary literature over reviews (but cite key reviews)
- Include seminal/classic papers
- Include recent papers (last 5 years)
- Balance between organoid and neuroscience literature
- Include methods papers for techniques discussed
...
4. Network connectivity comparison
5. Constraint impact diagram
6. Future directions roadmap

---

## APPENDIX: Search Strategy Template
...
4. Note heterogeneity sources
5. Draw evidence-based conclusions with uncertainty
...
□ All major claims have ≥2 independent sources
□ Evidence quality is explicitly assessed
□ Quantitative data is provided where available
□ Uncertainties and limitations are noted
□ Conflicting evidence is acknowledged
□ Gaps in knowledge are identified
□ Language precision is appropriate to evidence strength
□ References are complete and accurate
□ Methods are described sufficiently for evaluation
...
- Illustration/figure design support
- Editorial assistance
- Preprint feedback process
...
4. Start evidence synthesis for each subsection
5. Write iteratively with continuous quality checking
